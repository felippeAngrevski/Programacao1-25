...
namespace Aula05.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public IActionResult ExportFixedFile(){
            ...
            foreach (Customer c in CustomerData.Customers){
                fileContent +=
                    ...
                    String.Format("{0:32}", c.HomeAddress!.AddressType) + "\n";
        ...
        public IActionResult Delete(int? id){
            if(id is null || id.Value <= 0) return NotFound();
        ...
        public IActionResult ConfirmDelete(int? id){
            ...
            if (!_customerRepository.DeleteById(id.Value)) return NotFound();
        ...
        private bool SaveFile(string content, string fileName) {
            ...
            try{
                ...
                if (!System.IO.File.Exists(filepath)){
                    using (StreamWriter sw = System.IO.File.CreateText(filepath)) sw.Write(content);
                }
            }
